...
protocol ExchangeAssetsDelegate {
    func updatedMarketCaptaliation(jpy: Int)
}


class ExchangeAssetsView : SectionView, FundDelegate {
    
    init(exchange: Exchange, section: Int, tableView: UITableView) {
    ...
    var fund: Fund!
    var delegate: ExchangeAssetsDelegate?
}
